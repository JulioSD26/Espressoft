...
class ControladorVentasIndividualesAnuales():
    ...
    def insertar_datos_ventana_ventas_individuales_anuales(self, ventana_principal, id_empleado):
        ...
        ventana_principal.label_total_ventas_individuales_anuales.setText("${:,.2f}".format(total_ventas_sin_incluir_anio_en_curso))
        ...
        ventana_principal.label_ventas_anio_en_curso_ventas_individuales_anuales.setText("${:,.2f}".format(total_anio_en_curso))

        # aqui finalmente se suman el total del anio en curso y los totales de los otros anios
        ventana_principal.label_ventas_totales_anio_actual_incluido_ventas_individuales_anuales.setText("${:,.2f}".format(total_ventas_sin_incluir_anio_en_curso + total_anio_en_curso))
