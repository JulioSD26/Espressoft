...
class ControladorVentasTotalesAnuales():
    ...
    def insertar_datos_ventana_ventas_totales_anuales(self, ventana_principal):
        ...
        ventana_principal.label_porcentaje_ventas_totales_anuales.setText(calcular_porcentaje_de_ventas(obtener_total_de_ventas(diccionario_anios_y_totales.values()), obtener_meta_ventas(6)))
        ...
        llenar_datos_tabla(ventana_principal.tabla_ventas_totales_anuales, diccionario_anios_y_totales)
