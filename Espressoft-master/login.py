    ...
    def loggedin(self,Form):
        if verifica_usuario(self.campo_num_emp_login.text()) == True:
            if verifica_login(self.campo_num_emp_login.text(), self.campo_contrasenia_login.text()) == True:
                if obtener_usuario_loggeado().tipo_empleado == "administrador" or obtener_usuario_loggeado().tipo_empleado == "gerente":
                    Form.close()
                    window = MainWindow()
                    window.show()
                else:
                    self.mensaje.setText("No tiene permisos para acceder")
            else:
